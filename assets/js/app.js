        ...
        try {
            ...
            if (data.classes && data.classes.length > 0) {
                data.classes.forEach(cls => {
                    ...
                    classHtml += `<label style="display:flex;align-items:center;gap:6px;padding:2px 0;cursor:pointer;font-size:0.9em;"><input type="checkbox" class="copy-class-cb" value="${this.escapeHtml(cls.id)}" style="width:auto;flex-shrink:0;"> ${this.escapeHtml(cls.name)}${desc}</label>`;
                });
            }
            ...
            if (uTotal > 0) {
                ...
                classHtml += `<label style="display:flex;align-items:center;gap:6px;padding:2px 0;cursor:pointer;font-size:0.9em;"><input type="checkbox" id="copy-unassigned-cb" style="width:auto;flex-shrink:0;"> <em>Unassigned</em> (${uParts.join(', ')})</label>`;
            }
            ...
            if (data.scripts && data.scripts.length > 0) {
                data.scripts.forEach(s => {
                    ...
                    scriptHtml += `<label style="display:flex;align-items:center;gap:6px;padding:2px 0;cursor:pointer;font-size:0.9em;"><input type="checkbox" class="copy-script-cb" value="${this.escapeHtml(s.name)}" style="width:auto;flex-shrink:0;"> ${this.escapeHtml(s.name)} <span style="color:#666;">(${size})</span></label>`;
                });
            } else {
